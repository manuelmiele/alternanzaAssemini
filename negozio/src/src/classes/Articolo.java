...
public class Articolo {
    ...
    public Articolo(int prezzo, int id, int quantita, String tipo, String nome, String descrizione, String piattaforma) throws CtrlException{
    	setPrezzo(prezzo);
    	setId(id);
	...
	//setters
    public void setPrezzo(int prezzo) throws CtrlException{
    	if(prezzo>0){
		this.prezzo = prezzo;
    	} else {
    		prezzo=0;
